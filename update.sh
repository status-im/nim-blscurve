...
TOAST="$(ls -d "$HOME"/.nimble/pkgs2/nimterop-0.6.13*/nimterop/toast | head -n 1)"
"$TOAST" -n -p --prefix=_ --typemap=bool=int32 '-G=@\bin\b=src' '-G=@\bout\b=dst' -o="$CANDIDATE" vendor/blst/bindings/blst.h
