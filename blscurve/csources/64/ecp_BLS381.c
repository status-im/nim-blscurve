...
int ECP_BLS381_set(ECP_BLS381 *P,BIG_384_58 x)
{
    BIG_384_58 m,b;
    FP_BLS381 rhs;
...
int ECP_BLS381_get(BIG_384_58 x,ECP_BLS381 *P)
{
	ECP_BLS381 W;
	ECP_BLS381_copy(&W,P);
	ECP_BLS381_affine(&W);
...
{
	BIG_384_58 x,y;
	BIG_384_58_rcopy(x,CURVE_Gx_BLS381);
#if CURVETYPE_BLS381!=MONTGOMERY
	BIG_384_58_rcopy(y,CURVE_Gy_BLS381);
