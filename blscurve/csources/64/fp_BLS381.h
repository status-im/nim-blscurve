...
extern const BIG_384_58 Modulus_BLS381;	/**< Actual Modulus set in romf_yyy.c */
extern const BIG_384_58 R2modp_BLS381;	/**< Montgomery constant */
...
#define TBITS_BLS381 (MBITS_BLS381%BASEBITS_384_58)           /**< Number of active bits in top word */
 ...
 */
extern void FP_BLS381_rcopy(FP_BLS381 *y,const BIG_384_58 x);
 ...
 *
	...
	@param y FP result
 */
extern void FP_BLS381_nres(FP_BLS381 *y,BIG_384_58 x);
/**	@brief Converts from residue form back to BIG integer form
 *
	@param y FP number to be converted to BIG
	@param x BIG result
 */
extern void FP_BLS381_redc(BIG_384_58 x,FP_BLS381 *y);
 ...
 */
extern void FP_BLS381_mod(BIG_384_58 r,DBIG_384_58 d);

#ifdef FUSED_MODMUL
extern void FP_BLS381_modmul(BIG_384_58,BIG_384_58,BIG_384_58);
#endif
 ...
 */
extern void FP_BLS381_pow(FP_BLS381 *x,FP_BLS381 *y,BIG_384_58 z);
