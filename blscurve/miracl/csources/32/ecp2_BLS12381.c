...
void ECP2_BLS12381_toOctet(octet *W, ECP2_BLS12381 *Q, bool compress)
{
    ...
    BIG_384_29_toBytes(&(W->val[1]), b);
    FP_BLS12381_redc(b, &(qx.b));
    BIG_384_29_toBytes(&(W->val[MODBYTES_384_29+1]), b);
    if (!compress)
    {
        W->val[0] = 0x04;
        FP_BLS12381_redc(b, &(qy.a));
        BIG_384_29_toBytes(&(W->val[2 * MODBYTES_384_29+1]), b);
        FP_BLS12381_redc(b, &(qy.b));
        BIG_384_29_toBytes(&(W->val[3 * MODBYTES_384_29+1]), b);
...
int ECP2_BLS12381_fromOctet(ECP2_BLS12381 *Q, octet *W)
{
    ...
    BIG_384_29_fromBytes(b, &(W->val[1]));
    FP_BLS12381_nres(&(qx.a), b);
    BIG_384_29_fromBytes(b, &(W->val[MODBYTES_384_29+1]));
    FP_BLS12381_nres(&(qx.b), b);
    if (typ == 0x04)
    {
        BIG_384_29_fromBytes(b, &(W->val[2 * MODBYTES_384_29+1]));
        FP_BLS12381_nres(&(qy.a), b);
        BIG_384_29_fromBytes(b, &(W->val[3 * MODBYTES_384_29+1]));
