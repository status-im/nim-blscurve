...
extern const BIG_384_29 Modulus_BLS12381;	/**< Actual Modulus set in rom_field_yyy.c */
extern const BIG_384_29 ROI_BLS12381;	    /**< Root of unity set in rom_field_yyy.c */
extern const BIG_384_29 R2modp_BLS12381;	/**< Montgomery constant */
extern const BIG_384_29 CRu_BLS12381;       /**< Cube Root of Unity */
extern const BIG_384_29 SQRTm3_BLS12381; /**< Square root of -3 */
...
#define TBITS_BLS12381 (MBITS_BLS12381%BASEBITS_384_29)           /**< Number of active bits in top word */
 ...
 */
extern void FP_BLS12381_rcopy(FP_BLS12381 *y, const BIG_384_29 x);
 ...
 *
	...
	@param y FP result
 */
extern void FP_BLS12381_nres(FP_BLS12381 *y, BIG_384_29 x);
/**	@brief Converts from residue form back to BIG integer form
 *
	@param y FP number to be converted to BIG
	@param x BIG result
 */
extern void FP_BLS12381_redc(BIG_384_29 x, FP_BLS12381 *y);
 ...
 */
extern void FP_BLS12381_mod(BIG_384_29 r, DBIG_384_29 d);

#ifdef FUSED_MODMUL
extern void FP_BLS12381_modmul(BIG_384_29, BIG_384_29, BIG_384_29);
#endif
 ...
 */
extern void FP_BLS12381_pow(FP_BLS12381 *x, FP_BLS12381 *y, BIG_384_29 z);
