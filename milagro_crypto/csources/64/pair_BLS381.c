...
//    ECP_BLS381_affine(Q);
    ...
    for (i=nb-2; i>=1; i--)   //0
    {
        ...
        //bt=BIG_384_58_bit(n,i);
        bt=BIG_384_58_bit(n3,i)-BIG_384_58_bit(n,i);
        if (bt==1)
        {
...
static void glv(BIG_384_58 u[2],BIG_384_58 e)
{
    ...
    for (i=0; i<2; i++)
    {
        BIG_384_58_rcopy(t,CURVE_W_BLS381[i]);
//BIG_384_58_norm(t); BIG_384_58_norm(e);
    ...
    for (i=0; i<2; i++)
        for (j=0; j<2; j++)
        {
            BIG_384_58_rcopy(t,CURVE_SB_BLS381[j][i]);
...
static void gs(BIG_384_58 u[4],BIG_384_58 e)
{
    ...
    for (i=0; i<4; i++)
    {
        BIG_384_58_rcopy(t,CURVE_WB_BLS381[i]);
//BIG_384_58_norm(t); BIG_384_58_norm(e);
        BIG_384_58_mul(d,t,e);
        BIG_384_58_ddiv(v[i],d,q);
        BIG_384_58_zero(u[i]);
    ...
    for (i=0; i<4; i++)
        for (j=0; j<4; j++)
        {
            BIG_384_58_rcopy(t,CURVE_BB_BLS381[j][i]);
            BIG_384_58_modmul(t,v[j],t,q);
            BIG_384_58_add(u[i],u[i],q);
            BIG_384_58_sub(u[i],u[i],t);
            BIG_384_58_mod(u[i],q);
...
void PAIR_BLS381_G1mul(ECP_BLS381 *P,BIG_384_58 e)
{
...
/* f=f^e */
void PAIR_BLS381_GTpow(FP12_BLS381 *f,BIG_384_58 e)
{
...
const BIG_384_58 TEST_Gx={0x18AFF11A,0xF2EF406,0xAF68220,0x171F2E27,0x6BA0959,0x124C50E0,0x450BE27,0x7003EA8,0x8A914};
const BIG_384_58 TEST_Gy={0x6E010F4,0xA71D07E,0x7ECADA8,0x8260E8E,0x1F79C328,0x17A09412,0xBFAE690,0x1C57CBD1,0x17DF54};

const BIG_384_58 TEST_Pxa={0x1047D566,0xD83CD71,0x10322E9D,0x991FA93,0xA282C48,0x18AEBEC8,0xCB05850,0x13B4F669,0x21794A};
const BIG_384_58 TEST_Pxb={0x1E305936,0x16885BF1,0x327060,0xE26F794,0x1547D870,0x1963E5B2,0x1BEBB96C,0x988A33C,0x1A9B47};
const BIG_384_58 TEST_Pya={0x20FF876,0x4427E67,0x18732211,0xE88E45E,0x174D1A7E,0x17D877ED,0x343AB37,0x97EB453,0xB00D5};
const BIG_384_58 TEST_Pyb={0x1D746B7B,0x732F4C2,0x122A49B0,0x16267985,0x235DF56,0x10B1E4D,0x14D8F210,0x17A05C3E,0x5ECF8};

#endif

#if CHOICE==BN254_T2

const BIG_384_58 TEST_Gx={0x15488765,0x46790D7,0xD9900A,0x1DFB43F,0x9F2D307,0xC4724E8,0x5678E51,0x15C3E3A7,0x1BEC8E};
const BIG_384_58 TEST_Gy={0x3D3273C,0x1AFA5FF,0x1880A139,0xACD34DF,0x17493067,0x10FA4103,0x1D4C9766,0x1A73F3DB,0x2D148};

const BIG_384_58 TEST_Pxa={0xF8DC275,0xAC27FA,0x11815151,0x152691C8,0x5CDEBF1,0x7D5A965,0x1BF70CE3,0x679A1C8,0xD62CF};
const BIG_384_58 TEST_Pxb={0x1D17D7A8,0x6B28DF4,0x174A0389,0xFE67E5F,0x1FA97A3C,0x7F5F473,0xFFB5146,0x4BC19A5,0x227010};
const BIG_384_58 TEST_Pya={0x16CC1F90,0x5284627,0x171B91AB,0x11F843B9,0x1D468755,0x67E279C,0x19FE0EF8,0x1A0CAA6B,0x1CC6CB};
const BIG_384_58 TEST_Pyb={0x1FF0CF2A,0xBC83255,0x6DD6EE8,0xB8B752F,0x13E484EC,0x1809BE81,0x1A648AA1,0x8CEF3F3,0x86EE};
...
const BIG_384_58 TEST_Gx={0x14BEC4670E4EB7,0xEA2973860F6861,0x35C14B2FC3C28F,0x4402A0B63B9473,0x2074A81D};
const BIG_384_58 TEST_Gy={0xC284846631CBEB,0x34A6E8D871B3B,0x89FB94A82B2006,0x87B20038771FC,0x6A41108};

const BIG_384_58 TEST_Pxa={0xE4A00F52183C77,0x554E02DF4F8354,0xB65EB5CF1C2F89,0x8B71A87BFCFC9,0x49EEDB1};
const BIG_384_58 TEST_Pxb={0xCFB8FA9AA8845D,0x8A9CC76D966697,0x185BA05BF5EC08,0x76140E87D97226,0x1FB93AB6};
const BIG_384_58 TEST_Pya={0x3644CC1EDF208A,0xA637FB3FF8E257,0x4453DA2BB9E686,0xD14AD3CDF6A1FE,0xCD04A1E};
const BIG_384_58 TEST_Pyb={0x71BD7630A43C14,0x1CAA9F14EA264E,0x3C3C2DFC765DEF,0xCF59D1A1A7D6EE,0x11FF7795};
...
//	BIG_384_58_rcopy(r,CURVE_Order); BIG_384_58_dec(r,7); BIG_384_58_norm(r);
