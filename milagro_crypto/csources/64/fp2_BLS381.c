...
/* SU= 16 */
void FP2_BLS381_from_BIGs(FP2_BLS381 *w,BIG_384_58 x,BIG_384_58 y)
{
...
/* Create FP2 from BIG */
/* SU= 8 */
void FP2_BLS381_from_BIG(FP2_BLS381 *w,BIG_384_58 x)
{
    FP_BLS381_nres(&(w->a),x);
    FP_BLS381_zero(&(w->b));
}
...
void FP2_BLS381_mul(FP2_BLS381 *w,FP2_BLS381 *x,FP2_BLS381 *y)
{
    ...
    BIG_384_58_rcopy(p,Modulus_BLS381);
...
/* Set w=a^b mod m */
/* SU= 208 */
void FP2_BLS381_pow(FP2_BLS381 *r,FP2_BLS381* a,BIG_384_58 b)
{
    FP2_BLS381 w;
    FP_BLS381 one;
    BIG_384_58 z,zilch;
...
int main()
{
	...
	BIG_384_58 a,b,e;
	BIG_384_58 pp1,pm1;
	BIG_384_58_unity(a); BIG_384_58_unity(b);
	FP2_BLS381_from_BIGs(&w,a,b);
//	for (i=0;i<100;i++)
//	{
//		BIG_384_58_randomnum(a); BIG_384_58_randomnum(b);
//		BIG_384_58_mod(a,Modulus_BLS381); BIG_384_58_mod(b,Modulus_BLS381);
...
//exit(0);
	...
	BIG_384_58_zero(e); BIG_384_58_inc(e,27);
	FP2_BLS381_pow(&w,&w,e);
	FP2_BLS381_output(&w);
exit(0);
	BIG_384_58_rcopy(pp1,Modulus_BLS381);
	BIG_384_58_rcopy(pm1,Modulus_BLS381);
	BIG_384_58_inc(pp1,1);
	BIG_384_58_dec(pm1,1);
	BIG_384_58_norm(pp1);
	BIG_384_58_norm(pm1);
