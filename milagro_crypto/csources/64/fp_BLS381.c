...
void FP_BLS381_mod(BIG_384_58 r,DBIG_384_58 d)
{
    BIG_384_58 t,b;
    chunk v,tw;
    BIG_384_58_split(t,b,d,MODBITS_BLS381);
    ...
    if (MConst_BLS381 < NEXCESS_384_58)
    {
        BIG_384_58_imul(t,t,MConst_BLS381);
        BIG_384_58_norm(t);
        BIG_384_58_add(r,t,b);
        BIG_384_58_norm(r);
        tw=r[NLEN_384_58-1];
        r[NLEN_384_58-1]&=TMASK_BLS381;
        r[0]+=MConst_BLS381*((tw>>TBITS_BLS381));
    }
    else
    {
        v=BIG_384_58_pmul(t,t,MConst_BLS381);
        BIG_384_58_add(r,t,b);
        BIG_384_58_norm(r);
        tw=r[NLEN_384_58-1];
        r[NLEN_384_58-1]&=TMASK_BLS381;
#if CHUNK == 16
        r[1]+=muladd_384_58(MConst_BLS381,((tw>>TBITS_BLS381)+(v<<(BASEBITS_384_58-TBITS_BLS381))),0,&r[0]);
#else
        r[0]+=MConst_BLS381*((tw>>TBITS_BLS381)+(v<<(BASEBITS_384_58-TBITS_BLS381)));
#endif
    }
    BIG_384_58_norm(r);
}
...
void FP_BLS381_mod(BIG_384_58 r,DBIG_384_58 d)
{
    BIG_384_58 t,b;
    chunk carry;
    BIG_384_58_split(t,b,d,MBITS_BLS381);

    BIG_384_58_add(r,t,b);

    BIG_384_58_dscopy(d,t);
    BIG_384_58_dshl(d,MBITS_BLS381/2);
    ...
    BIG_384_58_norm(r);
    BIG_384_58_shl(t,MBITS_BLS381/2);

    BIG_384_58_add(r,r,t);

    carry=r[NLEN_384_58-1]>>TBITS_BLS381;
...
void FP_BLS381_mod(BIG_384_58 a,DBIG_384_58 d)
{
    int i;

    for (i=0; i<NLEN_384_58; i++)
        d[NLEN_384_58+i]+=muladd_384_58(d[i],MConst_BLS381-1,d[i],&d[NLEN_384_58+i-1]);
...
{
    BIG_384_58 m,t;
    BIG_384_58_rcopy(m,Modulus_BLS381);
	BIG_384_58_copy(t,x->g);
    BIG_384_58_mod(t,m);
    return BIG_384_58_iszilch(t);
}
...
void FP_BLS381_rcopy(FP_BLS381 *y, const BIG_384_58 c)
{
    BIG_384_58 b;
...
#endif
    /*
        if (c<=NEXCESS_384_58 && a->XES*c <= FEXCESS_BLS381)
    	{
            BIG_384_58_imul(r->g,a->g,c);
    		r->XES=a->XES*c;
    		FP_BLS381_norm(r);
    	}
        else
...
void FP_BLS381_pow(FP_BLS381 *r,FP_BLS381 *a,BIG_384_58 b)
{
...
void FP_BLS381_inv(FP_BLS381 *w,FP_BLS381 *x)
{
	...
	BIG_384_58 m2;
	BIG_384_58_rcopy(m2,Modulus_BLS381);
	BIG_384_58_dec(m2,2);
	BIG_384_58_norm(m2);
...
int main()
{
	...
	int i,carry;
	DBIG_384_58 c={0,0,0,0,0,0,0,0};
	BIG_384_58 a={1,2,3,4};
	BIG_384_58 b={3,4,5,6};
	BIG_384_58 r={11,12,13,14};
	BIG_384_58 s={23,24,25,15};
	BIG_384_58 w;

//	printf("NEXCESS_384_58= %d\n",NEXCESS_384_58);
//	printf("MConst_BLS381= %d\n",MConst_BLS381);

	BIG_384_58_copy(b,Modulus_BLS381);
	BIG_384_58_dec(b,1);
	BIG_384_58_norm(b);

	BIG_384_58_randomnum(r); BIG_384_58_norm(r); BIG_384_58_mod(r,Modulus_BLS381);
//	BIG_384_58_randomnum(s); norm(s); BIG_384_58_mod(s,Modulus_BLS381);
...
//	copy(r,a);
	printf("r=   "); BIG_384_58_output(r);
	BIG_384_58_modsqr(r,r,Modulus_BLS381);
	printf("r^2= "); BIG_384_58_output(r);
