...
/* Set r=a^b mod m */
/* SU= 240 */
void FP4_BLS381_pow(FP4_BLS381 *r,FP4_BLS381* a,BIG_384_58 b)
{
    FP4_BLS381 w;
    BIG_384_58 z,zilch;
    int bt;
...
void FP4_BLS381_xtr_pow(FP4_BLS381 *r,FP4_BLS381 *x,BIG_384_58 n)
{
    int i,par,nb;
    BIG_384_58 v;
    FP2_BLS381 w;
...
void FP4_BLS381_xtr_pow2(FP4_BLS381 *r,FP4_BLS381 *ck,FP4_BLS381 *cl,FP4_BLS381 *ckml,FP4_BLS381 *ckm2l,BIG_384_58 a,BIG_384_58 b)
{
    int i,f2;
    BIG_384_58 d,e,w;
...
int main(){
		...
		BIG_384_58_rcopy(md,Modulus);
		//Test w^(P^4) = w mod p^2
		BIG_384_58_zero(a); BIG_384_58_inc(a,27);
		BIG_384_58_zero(b); BIG_384_58_inc(b,45);
		FP2_BLS381_from_BIGs(&w0,a,b);

		BIG_384_58_zero(a); BIG_384_58_inc(a,33);
		BIG_384_58_zero(b); BIG_384_58_inc(b,54);
...
// Test 1/(1/x) = x mod p^4
		...
		BIG_384_58_zero(e); BIG_384_58_inc(e,12);
	...
	//	FP4_BLS381_xtr_A(&w,&t,&w,&t,&t);
		...
		BIG_384_58_zero(a); BIG_384_58_inc(a,37);
		BIG_384_58_zero(b); BIG_384_58_inc(b,17);
		FP2_BLS381_from_BIGs(&w0,a,b);

		BIG_384_58_zero(a); BIG_384_58_inc(a,49);
		BIG_384_58_zero(b); BIG_384_58_inc(b,31);
		FP2_BLS381_from_BIGs(&w1,a,b);
		...
		BIG_384_58_zero(e1); BIG_384_58_inc(e1,3331);
		BIG_384_58_zero(e2); BIG_384_58_inc(e2,3372);
