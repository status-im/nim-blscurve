...
void ECP2_BLS381_toOctet(octet *W,ECP2_BLS381 *Q)
{
    ...
    BIG_384_58_toBytes(&(W->val[2*MODBYTES_384_58]),b);
    FP_BLS381_redc(b,&(qy.b));
    BIG_384_58_toBytes(&(W->val[3*MODBYTES_384_58]),b);
...
void ECP2_BLS381_rhs(FP2_BLS381 *rhs,FP2_BLS381 *x)
{
    ...
    BIG_384_58_rcopy(b,CURVE_B_BLS381);
...
/* P*=e */
/* SU= 280 */
void ECP2_BLS381_mul(ECP2_BLS381 *P,BIG_384_58 e)
{
    /* fixed size windows */
    int i,nb,s,ns;
    BIG_384_58 mt,t;
...
int main()
{
	...
	BIG_384_58 r,xa,xb,ya,yb;

	BIG_384_58_rcopy(xa,CURVE_Pxa_BLS381);
	BIG_384_58_rcopy(xb,CURVE_Pxb_BLS381);
	BIG_384_58_rcopy(ya,CURVE_Pya_BLS381);
	BIG_384_58_rcopy(yb,CURVE_Pyb_BLS381);
...
//	BIG_384_58_copy(r,CURVE_Order_BLS381);
	BIG_384_58_rcopy(r,Modulus_BLS381);
