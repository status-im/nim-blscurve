...
void BIG_384_29_fromBytes(BIG_384_29 a,char *b)
{
    ...
    for (i=0; i<MODBYTES_384_29; i++)
    {
        ...
        //BIG_384_29_inc(a,(int)(unsigned char)b[i]); BIG_384_29_norm(a);
    }
#ifdef DEBUG_NORM
    a[MPV_384_29]=1;
    a[MNV_384_29]=0;
...
/* Set b=b mod c */
/* SU= 16 */
void BIG_384_29_mod(BIG_384_29 b,BIG_384_29 c)
{
    int k=0;
    BIG_384_29 r; /**/
...
/* Set r=a*b mod m */
/* SU= 96 */
void BIG_384_29_modmul(BIG_384_29 r,BIG_384_29 a,BIG_384_29 b,BIG_384_29 m)
{
    DBIG_384_29 d;
    BIG_384_29_mod(a,m);
    BIG_384_29_mod(b,m);
...
/* Set a=a*a mod m */
/* SU= 88 */
void BIG_384_29_modsqr(BIG_384_29 r,BIG_384_29 a,BIG_384_29 m)
{
    DBIG_384_29 d;
    BIG_384_29_mod(a,m);
    BIG_384_29_sqr(d,a);
...
/* Set r=-a mod m */
/* SU= 16 */
void BIG_384_29_modneg(BIG_384_29 r,BIG_384_29 a,BIG_384_29 m)
{
    BIG_384_29_mod(a,m);
...
/* Set a=a/b mod m */
/* SU= 136 */
void BIG_384_29_moddiv(BIG_384_29 r,BIG_384_29 a,BIG_384_29 b,BIG_384_29 m)
{
    DBIG_384_29 d;
    BIG_384_29 z;
    BIG_384_29_mod(a,m);
