...
const
  ...
  BMASK_384_29* = ((Chunk(1) shl BASEBITS_384_29) - 1)
  NEXCESS_384_29* = (1 shl (CHUNKBITS - BASEBITS_384_29 - 1))
  HBITS_384_29* = (BASEBITS_384_29 div 2)
  HMASK_384_29* = ((Chunk(1) shl HBITS_384_29) - 1)

type
  Octet* {.importc: "octet", header: milagroPath & "amcl.h", bycopy.} = object
...
proc BIG_384_29_comp*(a: BIG_384_29, b: BIG_384_29): int {.millagro_func.}
proc BIG_384_29_nbits*(a: BIG_384_29): cint {.millagro_func.}
proc BIG_384_29_shr*(a: BIG_384_29, k: int) {.millagro_func.}
proc BIG_384_29_shl*(a: BIG_384_29, s: int) {.millagro_func.}
proc BIG_384_29_fshr*(a: BIG_384_29, s: int) {.millagro_func.}
proc BIG_384_29_fshl*(a: BIG_384_29, s: int) {.millagro_func.}
proc BIG_384_29_dshl*(x: DBIG_384_29, s: int) {.millagro_func.}
...
proc ECP2_BLS381_fromOctet*(q: ptr ECP2_BLS381, w: ptr Octet) {.millagro_func.}
proc ECP_BLS381_toOctet*(w: ptr Octet, p: ptr ECP_BLS381, compress: bool) {.
     millagro_func.}
proc ECP_BLS381_fromOctet*(p: ptr ECP_BLS381, w: ptr Octet): int {.
     millagro_func.}
